...
const (
	CannotInvokeOperation WegoErrorCode = iota + 200000 // storeservice.errors.CannotInvokeOperation
	SecurityException                                    // storeservice.errors.SecurityException
	CannotCastResponse                                   // storeservice.errors.CannotCastResponse
)
