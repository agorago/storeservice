...
## test-mock: execute the BDD tests in mock mode
.PHONY: test-mock
test-mock: create-bin
	go test -v --tags mock ./... --godog.format=pretty -race -coverprofile=bin/coverage.txt -covermode=atomic
...
swagger-docs: swagger-gen-build
	...
	../togo/scripts/swagger/swagger-generate.sh storeService
